...
namespace RadzenBlazorServerADDemo.Pages
{
    public partial class SolutionUsers
    {
        ...
        protected IEnumerable<RadzenBlazorServerADDemo.Models.ConData.SolutionUser> solutionUsers;

        protected RadzenDataGrid<RadzenBlazorServerADDemo.Models.ConData.SolutionUser> grid0;
        ...
        protected async Task EditRow(DataGridRowMouseEventArgs<RadzenBlazorServerADDemo.Models.ConData.SolutionUser> args)
        {
            await DialogService.OpenAsync<EditSolutionUser>("Edit SolutionUser", new Dictionary<string, object> { {"UserID", args.Data.UserID} });
        }

        protected async Task GridDeleteButtonClick(MouseEventArgs args, RadzenBlazorServerADDemo.Models.ConData.SolutionUser solutionUser)
        {
            try
            {
